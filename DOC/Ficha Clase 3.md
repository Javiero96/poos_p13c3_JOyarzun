...
- **Nombre:** POKEMON
- **Responsabilidad principal:** Luchar en combates
- **Atributos necesarios:** Nivel, tipo, vida, daño, defensa
- **Métodos posibles:** curar, subir de nivel
- **Clase con la que necesita colaborar:** Combate
- **Regla o criterio de aceptación que la justifica:**  No se puede curar a un pokemon si es tiene su vida al 100%, no se puede subir de nivel si llego al nivel maximo
- **Responsabilidad que no debería asumir:** Ser capturado

- **Nombre:** Entrenador
- **Responsabilidad principal:** Capturar Pokemones
- **Atributos necesarios:** Nombre, medallas
- **Métodos posibles:** capturar, pelear, caminar
- **Clase con la que necesita colaborar:** inventario
- **Regla o criterio de aceptación que la justifica:**  no se puede capturar si no tiene pokebolas en el inventario o si no tiene pokemon con vida
- **Responsabilidad que no debería asumir:** administrar inventario

- **Nombre:** Inventario
- **Responsabilidad principal:** manipular objetos
- **Atributos necesarios:** capacidad maxima, cantidad de objetos
- **Métodos posibles:** mover objetos, soltar objetos, utilizar objeto
- **Clase con la que necesita colaborar:** Entrenador
- **Regla o criterio de aceptación que la justifica:**  no se puede soltar objetos si es que no hay ninguno
- **Responsabilidad que no debería asumir:** manipular pokemones
